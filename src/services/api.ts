...
// Fallback to local backend if API Gateway URL is not set
const API_BASE_URL = import.meta.env.VITE_API_GATEWAY_URL || import.meta.env.VITE_API_URL || 'http://localhost:5000/api/v1';
